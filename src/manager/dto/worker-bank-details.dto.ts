...
// Nested under CreateManagerWorkerDto/UpdateManagerWorkerDto's `bankDetails` field (mirrors
// ManagerBankDetailsDto's shape for the Admin Manager APIs). All sub-fields are optional and
// updated independently — sending a partial bankDetails object only overwrites the sub-fields
// present in it, leaving the rest of the worker's stored bank details as-is.
export class WorkerBankDetailsDto {
